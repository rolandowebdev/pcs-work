			...
			<div className='relative flex items-center justify-between h-full max-w-lg mx-auto font-medium bg-white p-2 border rounded-t-md shadow-2xl'>
				<div className='flex items-center'>
					<Button
						...
						<HomeIcon
							size={24}
							className='group-hover:stroke-rose-600 text-gray-600'
						/>
						<span className='group-hover:text-rose-600 text-xs text-gray-600 dark:text-gray-400 font-bold'>
							Home
						</span>
					</Button>
				...
				<div className='group flex flex-col items-center gap-2 absolute left-1/2 -top-6 -translate-x-1/2'>
